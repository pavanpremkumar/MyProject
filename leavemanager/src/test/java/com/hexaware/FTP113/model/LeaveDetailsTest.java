...
/**
  ...
  * @param dao mocking the dao class.
  ...
  public final void testListAllSomePen(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    new Expectations() {
      {
        final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        final String s1 = "1998-12-12";
        ...
        final String s3 = "1998-12-10";
        final Date l = sdf.parse(s3);
        final ArrayList<LeaveDetails> pe = new ArrayList<LeaveDetails>();
        pe.add(new LeaveDetails(1, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "sick", l, "takecare"));
        pe.add(new LeaveDetails(3, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "function", l, "Enjoy"));
        pe.add(new LeaveDetails(2, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "marriage", l, "Enjoy"));
        pe.add(new LeaveDetails(4, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "sick", l, "takecare"));
        dao.pending(1);
        result = pe;
      }
    };
    ...
    LeaveDetails[] pe = LeaveDetails.listPending(1);
    assertEquals(4, pe.length);
    final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    final String s1 = "1998-12-12";
    final Date s = sdf.parse(s1);
    final String s2 = "1998-12-12";
    ...
    final String s3 = "1998-12-10";
    final Date l = sdf.parse(s3);
    assertEquals(new LeaveDetails(1, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "sick", l, "takecare"), pe[0]);
    assertEquals(new LeaveDetails(3, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "function", l, "Enjoy"), pe[1]);
    assertEquals(new LeaveDetails(2, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "marriage", l, "Enjoy"), pe[3]);
    assertEquals(new LeaveDetails(4, 1, 4, s, e, LeaveType.EL, LeaveStatus.APPROVED, "sick", l, "takecare"), pe[4]);
  }
  /**
  ...
  */
  ...
  public final void testApplyLeave(@Mocked final EmployeeDAO edao, @Mocked final LeaveDetailsDAO ldao)
    ...
    final String strToday = sdf.format(curDate);
    ...
    new Expectations() {
      {
        ldao.insert(18, 1, "2019-04-30", "2019-04-30", LeaveType.EL, LeaveStatus.APPROVED, "Sick", strToday);
        ldao.insert(19, 1, "2019-04-30", "2019-04-30", LeaveType.EL, LeaveStatus.PENDING, "Sick", strToday);
      }
    };
    new MockUp<LeaveDetails>() {
      @Mock
    ...
    String res3 = LeaveDetails.applyLeave(18, "2019-04-26", "2019-04-28", 1, LeaveType.EL, "Sick");
    ...
    String res5 = LeaveDetails.applyLeave(17, "2019-04-26", "2019-04-28", 3, LeaveType.EL, "Sick");
    assertEquals(res5, "Insufficient leave balance.. ");
    String res6 = LeaveDetails.applyLeave(500, "2019-04-26", "2019-04-28", 3, LeaveType.EL, "Sick");
    ...
    String res9 = LeaveDetails.applyLeave(19, "2019-04-27", "2019-04-29", 1, LeaveType.EL, "Sick");
    assertEquals(res9, "StartDate cannot be saturday...");
    String res10 = LeaveDetails.applyLeave(19, "2019-04-28", "2019-04-30", 1, LeaveType.EL, "Sick");
    assertEquals(res10, "StartDate cannot be sunday...");
  }
    /**
  * @param edao for mocking EmployeeDAO class.
  * @param ldao for mocking LeaveDetailsDAO class.
  ...
  */
  @Test
  public final void testapproveDeny(@Mocked final EmployeeDAO edao, @Mocked final LeaveDetailsDAO ldao)
  throws ParseException {
    final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    final String sd1 = "1998-12-12";
    final Date doj3 = sdf.parse(sd1);
    String s1 = "2019-02-12";
    Date sd = sdf.parse(s1);
    String s2 = "2019-02-13";
    Date ed  = sdf.parse(s2);
    String s3 = "2019-02-06";
    Date ad = sdf.parse(s3);
    final Employee e800 = new Employee(800, "sanjana", "sanjanakolge1596@gmail.com", "7768858666",
                                       doj3, "Programmer", 0, 34);
    final LeaveDetails ld200 = new LeaveDetails(2, 800, 3, sd, ed, LeaveType.EL,
                                                LeaveStatus.APPROVED, "Sick", ad, "ENJOY");
    new Expectations() {
      {
        ldao.find(2); result = ld200;
        ldao.find(500); result = null;
      }
    };
    new Expectations() {
      {
        edao.find(800); result = e800;
      }
    };
    new Expectations() {
      {
        ldao.approveDeny(2, "APPROVED", "ENJOY");
      }
    };
    new MockUp<LeaveDetails>() {
      @Mock
    ...
    String res = LeaveDetails.approveDeny(2, 0, "YES", "ENJOY");
    assertEquals(res, "Leave Approved Sucessfully...");
    String res1 = LeaveDetails.approveDeny(2, 0, "NO", "DONT ENJOY");
    assertEquals(res1, "Leave Rejected");
    String res2 = LeaveDetails.approveDeny(2, 2, "NO", "DONT ENJOY");
    assertEquals(res2, "You are unauthorised to approve the leave");
    String res3 = LeaveDetails.approveDeny(500, 2, "NO", "DONT ENJOY");
