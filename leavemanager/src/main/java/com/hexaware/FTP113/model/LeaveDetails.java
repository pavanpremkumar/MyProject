...
/**
   ...
   * @param argLeaLeaveType to initialize type of leave.
  ...
  public static String applyLeave(final int argEmpId,
                                  ...
                                  final LeaveType argLeaLeaveType,
    ...
    if (e != null) {
      ...
      if (calendar.get(Calendar.DAY_OF_WEEK) == Calendar.SATURDAY) {
        res = "StartDate cannot be saturday...";
      } else if (calendar.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY) {
        res = "StartDate cannot be sunday...";
      } else if (count >= 1) {
        ...
        dao().insert(argEmpId, argLeaNumberOfDays, argLeaStartDate, argLeaEndDate,
                     argLeaLeaveType, leaStatus, argLeaReason, leaAppliedOn);
